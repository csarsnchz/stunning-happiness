...
export const GptMessageSelectedImage = ({ imageUrl, alt, onImageSelected }: Props) => {
  const orginalImageRef = useRef<HTMLImageElement>();
  ...
  const onMouseMove = (
    ...
    ctx.drawImage(orginalImageRef.current!, 0, 0, canvaWidth, canvaHeight);
